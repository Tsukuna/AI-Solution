...
<section class="relative bg-purple-700 bg-cover bg-center bg-no-repeat min-h-[350px] md:min-h-[450px] lg:min-h-[500px] flex items-center justify-center">
    ...
    <div class="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 md:px-8 mb-5">
        <!-- Mission Statement -->
        ...
        <p class="mt-4 text-base sm:text-lg md:text-xl text-gray-200 max-w-3xl drop-shadow-lg">
            Our mission is to revolutionize the digital employee experience by leveraging AI-driven solutions to empower businesses with efficiency, automation, and innovation.
        </p>

        <!-- Purpose Statement -->
        <div class="mt-6 max-w-2xl">
            <h2 class="text-xl sm:text-2xl font-semibold text-white drop-shadow-lg">Our Purpose</h2>
            <p class="mt-2 text-sm sm:text-lg text-gray-300 drop-shadow-lg">
                We create cutting-edge AI-powered solutions that enhance productivity, reduce operational friction, and drive intelligent decision-making.
            </p>
        </div>

        <!-- Core Values -->
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl">
            <div class="p-4 bg-white bg-opacity-20 rounded-lg shadow-lg">
                <h3 class="text-lg sm:text-xl font-semibold text-white drop-shadow-lg">Innovation</h3>
                <p class="text-gray-200 text-xs sm:text-sm mt-2 drop-shadow-lg">We continuously push the boundaries of AI to drive business transformation.</p>
            </div>
            <div class="p-4 bg-white bg-opacity-20 rounded-lg shadow-lg">
                <h3 class="text-lg sm:text-xl font-semibold text-white drop-shadow-lg">Integrity</h3>
                <p class="text-gray-200 text-xs sm:text-sm mt-2 drop-shadow-lg">We uphold transparency, trust, and ethical AI implementation.</p>
            </div>
            <div class="p-4 bg-white bg-opacity-20 rounded-lg shadow-lg">
                <h3 class="text-lg sm:text-xl font-semibold text-white drop-shadow-lg">Excellence</h3>
                <p class="text-gray-200 text-xs sm:text-sm mt-2 drop-shadow-lg">We strive to deliver AI solutions that exceed expectations.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <p class="font-body text-gray-500 lg:mb-16 sm:text-xl">Explore the whole collection of open-source web components and elements built with the utility classes from Tailwind</p>
        </div>
