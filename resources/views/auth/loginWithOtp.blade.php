...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form action="{{route('login.otp.post')}}" method="POST">
            ...
            <div class="mb-4">
                <label for="otp" class="block text-sm font-semibold text-gray-600 mb-1">One-Time Password (OTP)</label>
                <input
                    type="text"
                    id="otp"
                    name="otp"
                    class="w-full px-4 py-2 border border-gray-300 font-thin rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-300"
        ...
        <div class="text-center mt-6">
            <a href="{{route('login.otp')}}" class="text-sm text-primary-600 hover:underline">Resend OTP</a>
        </div>
    </div>
</body>
<script>
