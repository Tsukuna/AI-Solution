...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form action="{{ route('reset.password.post') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="password" class="block text-sm font-body text-gray-700">New Password</label>
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-body text-gray-700">Confirm New Password</label>
